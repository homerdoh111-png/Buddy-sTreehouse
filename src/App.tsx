...
function App() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      >
        <div className="bg-gradient-to-r from-indigo-500/30 via-purple-500/30 to-pink-500/30 backdrop-blur-sm rounded-3xl p-6 shadow-2xl border-2 border-white/20">
